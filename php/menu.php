...
<html>
    ...
    <body>
      ...
      <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
        <!-- Brand -->
        <img src="../pictures/mind_map.svg" alt="logo" style="width:40px;">
        <a class="navbar-brand" style="margin-left:10px; color:silver; background-color:transparent;" href="../index.php">SysAdminWeb</a>
        <div class="dropdown">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="../php/ipinfos.php">IP infos</a>
            <a class="dropdown-item" href="#">Another action</a>
            <a class="dropdown-item" href="#">Something else here</a>
          </div>
        </div>
