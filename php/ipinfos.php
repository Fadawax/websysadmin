...
<html>
    <head>
        ...
        <link rel="icon" href="../pictures/mind_map.svg" sizes="any" type="image/svg+xml"/>
    ...
    <form action="ipinfos.php" style="position:relative; margin-top:60px; margin-left:auto; margin-right:auto; width:90%; background-color:silver; border-radius:5px; box-shadow:5px 5px 0px grey;">
        <div style="position:relative; padding-top:10px; text-align:center;">
        	<input type="text" class="form-control" placeholder="IP a analyser" name="IP a analyser" style="width:200px; display:inline-block; ">
        	<button type="submit" class="btn btn-primary" style="width:100px;">Tester</button>
		</div>
